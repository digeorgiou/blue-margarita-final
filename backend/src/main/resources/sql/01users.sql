...
(3, 'digeo', '$2a$11$fP8pczMMVsi/zGbJ2ZKDB.4hMaBl9pYSHdFFuTjQfLxE8/pcNfKa2', 'USER', 1, CURRENT_TIMESTAMP(), CURRENT_TIMESTAMP(), NULL, NULL, UUID()),
...
--Deleted user
(5, 'john(deleted)', '$2a$11$fP8pczMMVsi/zGbJ2ZKDB.4hMaBl9pYSHdFFuTjQfLxE8/pcNfKa2', 'USER', 0, CURRENT_TIMESTAMP(), CURRENT_TIMESTAMP(), NULL, NULL, UUID());
