...
//    public ResponseEntity<Map<String, Object>> getStockManagementOverview() {
//        Map<String, Object> overview = new HashMap<>();
//
//        // Get products by stock status for quick overview
//        ProductFilters lowStockFilters = ProductFilters.builder()
//                .lowStock(true)
//                .isActive(true)
//                .build();
//        lowStockFilters.setPage(0);
//        lowStockFilters.setPageSize(10);
//        lowStockFilters.setSortBy("stock");
//        lowStockFilters.setSortDirection(Sort.Direction.ASC);
//
//        // Get negative stock products (most urgent)
//        ProductFilters negativeStockFilters = ProductFilters.builder()
//                .maxStock(-1) // Negative stock
//                .isActive(true)
//                .build();
//        negativeStockFilters.setPage(0);
//        negativeStockFilters.setPageSize(10);
//        negativeStockFilters.setSortBy("stock");
//        negativeStockFilters.setSortDirection(Sort.Direction.ASC);
//
//        overview.put("lowStockProducts", productService.getProductsForStockManagement(lowStockFilters));
//        overview.put("negativeStockProducts", productService.getProductsForStockManagement(negativeStockFilters));
//
...
//            description = "Retrieves products with stock levels at or below their low stock alert thresholds. Used for reordering alerts and inventory planning.",
//            responses = {
//                    @ApiResponse(
//                            responseCode = "200",
...
//    @PreAuthorize("hasAnyRole('USER', 'ADMIN')")
//    public ResponseEntity<Paginated<StockManagementDTO>> getLowStockProducts(
//            @Parameter(description = "Page number (0-based)") @RequestParam(required = false, defaultValue = "0") int page,
//            @Parameter(description = "Page size") @RequestParam(required = false, defaultValue = "20") int pageSize,
//            @Parameter(description = "Sort field") @RequestParam(required = false, defaultValue = "stock") String sortBy,
//            @Parameter(description = "Sort direction") @RequestParam(required = false, defaultValue = "ASC") String sortDirection) {
...
//        }
//
//        List<StockUpdateResultDTO> results = productService.updateMultipleProductsStock(bulkUpdate);
