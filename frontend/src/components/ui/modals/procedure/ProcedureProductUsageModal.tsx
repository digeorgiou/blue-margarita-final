...
const ProcedureProductUsageModal: React.FC<ProcedureProductUsageModalProps> = ({
    ...
    }, [isOpen, procedure, currentPage, pageSize, searchTerm, selectedCategoryId ]);
    ...
    const loadProducts = async () => {
        ...
        setLoading(true);
        try {
            const result = await procedureService.getAllProductsUsingProcedure(procedure.procedureId, {
                    ...
                    <div className="flex items-center space-x-3">
                        ...
                        <div>
                            <h2 className="text-xl font-semibold">
                                Προϊόντα που χρησιμοποιούν: {procedure?.name}
                            </h2>
                        ...
                        <div className="flex flex-col sm:flex-row gap-4">
                            ...
                            <div className="flex items-center gap-2">
                                ...
                                <select
                                    ...
                                    className="border border-gray-200 rounded-lg px-3 py-2 text-sm focus:ring-2 focus:ring-orange-500 focus:border-transparent"
                                >
                            ...
                            <div className="text-center">
                                ...
                                <p className="text-gray-500">
                                    {searchTerm || selectedCategoryId
                                        ...
                                        : 'Δεν υπάρχουν προϊόντα που χρησιμοποιούν αυτή τη διαδικασία.'
                                    }
                                </p>
                            </div>
                        </div>
...
export default ProcedureProductUsageModal;